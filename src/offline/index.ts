...
export { initSync, syncNow, discardPending, queueOperation, queueFeatureUpdate, applyConflictResolutions, onSyncStateChange, getSyncState, clearConflicts, ConflictError } from './sync';
