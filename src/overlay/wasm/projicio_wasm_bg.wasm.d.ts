...
export const missing_grids: (a: number, b: number) => [number, number];
export const register_grid: (a: number, b: number, c: number, d: number) => [number, number];
export const registered_grids: () => [number, number];
